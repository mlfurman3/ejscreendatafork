...
##  WRITE FILES TO A LOCAL PINS BOARD

# local pins board will be in pkgdown/assets/data ####

board = pins::board_folder(here::here("pkgdown/assets/data"))
...
x = EJAM::dataload_from_pins(varnames = 'all', justchecking = T)
if (is.null(x)) {
